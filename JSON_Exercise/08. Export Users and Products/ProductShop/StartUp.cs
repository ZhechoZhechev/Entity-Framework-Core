...
public class StartUp
{
    ...
    public static string GetCategoriesByProductsCount(ProductShopContext context)
    {
        ...
        var categoriesQuery = context.Categories
            ...
            .ProjectTo<CategoriesByProductsCountDTO>(mapperConfig)
            .ToArray();

        string json = JsonConvert.SerializeObject(categoriesQuery, Formatting.Indented);
        return json;
    }

    public static string GetUsersWithProducts(ProductShopContext context)
    {
        var usersProdutsInfo = context.Users
            .Where(u => u.ProductsSold.Any(p => p.BuyerId.HasValue))
            .OrderByDescending(p => p.ProductsSold.Where(p => p.BuyerId.HasValue).Count())
            .Select(u => new
            {
        ...
        var JsonInfo = new
        {
            usersCount = usersProdutsInfo.Count(),
            users = usersProdutsInfo
        };
        ...
        string json = JsonConvert.SerializeObject(JsonInfo, jsonOption);
